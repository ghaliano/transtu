...
{
    /**
     * Gets the private 'App\Repository\PathRepository' shared autowired service.
     *
     * @return \App\Repository\PathRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PathRepository.php';

        return $container->privates['App\\Repository\\PathRepository'] = new \App\Repository\PathRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
