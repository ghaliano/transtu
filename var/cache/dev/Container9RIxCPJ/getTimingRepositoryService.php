 ...
 */
class getTimingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TimingRepository' shared autowired service.
     *
     * @return \App\Repository\TimingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TimingRepository.php';

        return $container->privates['App\\Repository\\TimingRepository'] = new \App\Repository\TimingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
